...
// Địa chỉ thanh toán hoá đơn của NgânLượng.vn
    ...
    public $merchant_site_code = '36680'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn
    // Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
    public $secure_pass = 'matkhauketnoi'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
     ...
     * @return string
     */
    public function buildCheckoutUrlExpand($return_url, $receiver, $transaction_info, $order_code, $price, $currency, $quantity , $tax , $discount , $fee_cal, $fee_shipping , $order_description , $buyer_info , $affiliate_code , $cancel_url)
    {
        ...
        $this->create_order_params = array(
            ...
            'buyer_info' => strval($buyer_info), //"Họ tên người mua *|* Địa chỉ Email *|* Điện thoại *|* Địa chỉ"
        ...
        $this->create_order_params['cancel_url'] = $cancel_url;
